...
class QuestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'values' => ['type' => 'json', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'questions_ibfk_1' => ['type' => 'foreign', 'columns' => ['rubric_id'], 'references' => ['rubrics', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
